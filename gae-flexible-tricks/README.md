...
We use the bash script `gae-promote.sh` to implement this. If you want to run this script on a mac then install `gdate` with 'brew install gdate' and swap 'date' with 'gdate' in the script.
