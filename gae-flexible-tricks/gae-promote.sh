...
# We use this script to implement this.
# If you want to run this script on a mac then install `gdate` with 'brew install coreutils' and swap 'date' with 'gdate' in the script.
